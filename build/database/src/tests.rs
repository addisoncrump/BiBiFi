...
fn basic_full_1() -> Result<(), Box<dyn Error>> {
    ...
    //change the default
    my_database.set_default_delegator(&"alice".to_string());
...
fn basic_full_2() -> Result<(), Box<dyn Error>> {
    ...
    my_database.delegate(&Target::Variable("my_var3".to_string()), &"admin".to_string(), &Right::Read, &"alice".to_string());
    my_database.delegate(&Target::Variable("my_var3".to_string()), &"admin".to_string(), &Right::Write, &"alice".to_string());
    my_database.delegate(&Target::Variable("my_var3".to_string()), &"admin".to_string(), &Right::Append, &"alice".to_string());
    my_database.delegate(&Target::Variable("my_var3".to_string()), &"admin".to_string(), &Right::Delegate, &"alice".to_string());

    //add principals to database after new default alice has some permissions other than prev default anyone
    my_database.create_principal(&"git".to_string(), &hash("git_pass".to_string()) );
    // check for in-correct permissions
    assert_eq!(
        my_database.check_right(&Target::Variable("my_var3".to_string()), &Right::Read, &"john".to_string()) |
            my_database.check_right(&Target::Variable("my_var3".to_string()), &Right::Write, &"john".to_string()) |
            my_database.check_right(&Target::Variable("my_var3".to_string()), &Right::Append, &"john".to_string()) |
            my_database.check_right(&Target::Variable("my_var3".to_string()), &Right::Delegate, &"john".to_string()),
        false
    );
